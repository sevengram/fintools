...
class TechIndicators(av):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_ema(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_wma(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_dema(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_tema(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_trima(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_kama(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_mama(self, symbol, interval='60min', time_period=20,
      series_type='close',
  ...
  @av._output_format
  @av._call_api_on_func
  def get_t3(self, symbol, interval='60min', time_period=20,
      series_type='close'):
    """ Return triple exponential moving average time series in two json
    objects as data and meta_data. It raises ValueError when problems arise
  ...
  @av._output_format
  @av._call_api_on_func
  def get_rsi(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_mom(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_cmo(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_roc(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_rocr(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_aroon(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_aroonosc(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_mfi(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_trix(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_dx(self, symbol, interval='60min', time_period=20,
      series_type='close'):
  ...
  @av._output_format
  @av._call_api_on_func
  def get_bbands(self, symbol, interval='60min', time_period=20,
      series_type='close',
  ...
  @av._output_format
  @av._call_api_on_func
  def get_midpoint(self, symbol, interval='60min', time_period=20,
      series_type='close'):
